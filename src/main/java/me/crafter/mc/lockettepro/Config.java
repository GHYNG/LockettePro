...
public class Config {
	...
	public static void reload() {
		...
		lockexpirestring = ChatColor.translateAlternateColorCodes('&', config.getString("lock-expire-string", "&3[Expired]"));
	...
	public static void initDefaultConfig() {
		...
		String[] lockables = {"CHEST", "TRAPPED_CHEST", "FURNACE", "BURNING_FURNACE", "HOPPER", "BREWING_STAND", "DIAMOND_BLOCK", "OAK_DOOR", "SPRUCE_DOOR", "BIRCH_DOOR", "JUNGLE_DOOR", "ACACIA_DOOR", "DARK_OAK_DOOR", "IRON_DOOR", "LECTERN", "CRIMSON_DOOR", "WARPED_DOOR"};
	...
	public static void initAdditionalFiles() {
		String[] availablefiles = {"lang.yml", "lang_zh-cn.yml", "lang_es.yml", "lang_it.yml", "lang_de.yml", "lang_hu.yml", "lang_pl.yml", "lang_fr.yml"};
